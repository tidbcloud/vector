	...
	whats_next: [
		{
			...
			description: """
				With this release, [we've switched the default for disk buffers to the new `v2`
				implementation](/highlights/2022-04-06-disk-buffer-v2-stable). Tthis means if you set `type
	...
	description: """
		...
		**Important**: as part of this release, we have promoted the new implemenation of disk buffers (`buffer.type
		...
		- [Support for iteration has landed in VRL](/highlights/2022-05-18-vrl-iteration-support). Now you can
		  dynamically map unknown key/value pairs and fields that are arrays. This replaces some common use cases for
		  the `lua` transform with the much more performant `remap` transform.
